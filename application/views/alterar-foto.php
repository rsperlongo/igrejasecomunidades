        ...
        <div class="container">
                   ...
                   <!-- <header><h3>Bem vindo, Igreja</h3></header> -->
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li class="active"><a href="<?php echo base_url('alterar-foto') ?>"><i class="fa fa-photo"></i><span>Cadastro de Fotos e Vídeos</span></a></li>
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="profile">
                        <header><h1>Alterar Foto / Video</h1></header>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <form role="form" id="form-account-profile" method="post" >
                                        ...
                                        <section id="agency">
                                            <h3>Escolha Foto ou Imagem</h3>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4">
                                            <label for="alterar-video">Alterar Vídeo 1:</label>
                                        </div>
                                        <div class="col-md-8 col-sm-8">
                                            <div class="form-group">
                                                <input type="text" class="form-group" placeholder="Digite a URL do Vídeo do You Tube">
                                            </div>
                                      </div>
                                      <div class="col-md-4 col-sm-4">
                                            <label for="alterar-video">Alterar Vídeo 2:</label>
                                        </div>
                                        <div class="col-md-8 col-sm-8">
                                            <div class="form-group">
                                                <input type="text" class="form-group" placeholder="Digite a URL do Vídeo do You Tube">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <label for="account-agency">Alterar Banner:</label>
                                    </div>
                                        <div class="col-md-8 col-sm-8">
                                            <div class="form-group">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
